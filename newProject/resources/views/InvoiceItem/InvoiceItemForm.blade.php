        ...
        @if(isset($invoice))
            <form method="post" action="{{route('invoice.update', $invoice->id)}}">
                ...
                <div id="invoice">
                    ...
                    <label for="cost_wod">Price without discount</label><br>
                    <input required type="text" id="cost_wod" name="cost_wod" class="cost_wod" value="{{$invoice->total_cost}}" autocomplete="off"><br>
                    <span id="SpanCost" class="error">@error('cost_wod'){{$message}}@enderror</span> <br>

                    <label for="discount">Discount in %</label><br>
                    <input required type="text" id="discount" name="discount" class="discountcost" size="50" value=5 ><br>
                    <span id="SpanDiscount" class="error">@error('discount'){{$message}}@enderror</span> <br>

                    <label for="tax">Tax %</label><br>
                    <input required type="text" id="tax" name="tax" class="tax" size="50" value=18><br>
                    <span id="SpanTax" class="error">@error('tax'){{$message}}@enderror</span> <br>

                    <label for="dcost">Price with discount and tax</label><br>
                    <input required type="text" id="dcost" name="dcost" class="dcost" value="{{$invoice->final_cost}}" autocomplete="off"><br>
                    <span id="SpanDcost" class="error">@error('dcost'){{$message}}@enderror</span> <br>

                    <label for="advance">Advance payment</label><br>
                    <input required type="text" id="advance" name="advance" class="advance"
                    ...
                    <input required type="text" id="due" name="due" class="due" value="{{$invoice->due}}" autocomplete="off"><br>
                    <span id="SpanDue" class="error">@error('due'){{$message}}@enderror</span> <br>

                    <label for="comintent">Comintent</label><br>
                    <input required type="text" id="comintent" name="comintent" class="comintent" value="{{$comintent}}" autocomplete="off"><br>
    ...
    @else
        <form method="post" action="{{route('invoice.store')}}">
            ...
            <div id="invoice">
                ...
                <input required type="text" id="cost_wod" name="cost_wod" class="cost_wod" value="{{@old('cost_wod')}}" readonly><br>
                <span id="SpanCost" class="error">@error('cost_wod'){{$message}}@enderror</span> <br>

                <label for="discount">Discount in %</label><br>
                <input required type="number" id="discount" name="discount" class="discountcost" size="50" value=5
                       onkeyup="itemValue()"><br>
                <span id="SpanDiscount" class="error">@error('discount'){{$message}}@enderror</span> <br>

                <label for="tax">Tax %</label><br>
                <input required type="number" id="tax" name="tax" class="tax" size="50" value=18
                       onkeyup="itemValue()"><br>
                <span id="SpanTax" class="error">@error('tax'){{$message}}@enderror</span> <br>

                <label for="dcost">Cost with discount and tax</label><br>
                <input required type="text" id="dcost" name="dcost" class="dcost" readonly value="{{@old('dcost')}}"><br>
                <span id="SpanDcost" class="error">@error('dcost'){{$message}}@enderror</span> <br>
                ...
                <label for="due">Due amount</label><br>
                <input required type="text" id="due" name="due" class="due" value="{{@old('due')}}"><br>
                <span id="SpanDue" class="error">@error('due'){{$message}}@enderror</span> <br>

                <label for="comintent">Comintent</label><br>
                <input required type="text" id="comintent" name="comintent" class="comintent" value="{{@old('comintent')}}"><br>
